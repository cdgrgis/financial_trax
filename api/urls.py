...
from .views.fund_info_views import FundInfosView, FundInfoDetailView
...
urlpatterns = [
    ...
    path('fundinfos/', FundInfosView.as_view(), name='fundinfos'),
    path('fundinfos/<int:pk>/', FundDetailView.as_view(), name='fund_info_detail'),
